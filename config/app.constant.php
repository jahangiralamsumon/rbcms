...
define('MANDRILL_TEMPLATE_FORGOT_PASSWORD', 'forgot-password-cms-en');
define('MANDRILL_TEMPLATE_FEEDBACK_REPLY', 'feedback-reply-cms-en');
define('MANDRILL_TEMPLATE_SEND_MESSAGE', 'send-message-cms-en');
define('EMAIL_TYPE', 'SMTP');
define('IS_EMAIL_SEND', 'NO');
