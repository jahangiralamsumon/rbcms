...
?>
  ...
  <!-- Select2 -->
  <link rel="stylesheet" href="<?php echo $this->request->webroot; ?>admin_lte/plugins/select2/select2.min.css">
  <!-- Theme style -->
...
<script src="<?php echo $this->request->webroot; ?>admin_lte/plugins/select2/select2.full.min.js"></script>
