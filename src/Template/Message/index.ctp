...
<?php
                    if (array_key_exists("index", $module_pages)):
                        ...
                        foreach ($user_permission as $permission):
                            if ($permission['page_id'] == $page_id):?>
                                    <a href="<?php echo $this->Url->build('/message/sent/'); ?>"  class="btn btn-success btn-flat btn-grid">
                                        <i class="fa fa-list"></i>
                                        <?php echo __('Sent Mail'); ?>
                                    </a>
                                    <?php
	                                break;
	                            endif;
                            ...
                            <?php
									...
									$page_id = $module_pages ["delete"];
										foreach ( $user_permission as $permission ) :
											if ($permission ['page_id'] == $page_id) :
										?>
                                         <?= $this->Form->create(null, ['url' => ['controller' => 'message', 'action' => 'bulkAction']]); ?>
            ...
            <div class="box-body table-responsive ">
              <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
									...
									<th class="sorting_asc"><?= $this->Paginator->sort('Message.sender_id', ['value' => __('From')]) ?></th>
                                ...
                                foreach ($messages as $message):?>
                                    <tr class= <?php echo $message->message['is_read']=='0' ? "info" : "";?>>
                                        <td>
                                           <!-- <div class="checkbox"> -->
                                                <input type="checkbox" 
                  ...
                  <li>  
                    	<?php
                            if (array_key_exists("view", $module_pages)):
                                ...
                                foreach ($user_permission as $permission):
                                    if ($permission['page_id'] == $page_id):?>
                                            <a  class="view_msg" href="<?php echo $this->Url->build(['action' => 'view', $message->message['msg_id']]) ?>"><i class="fa fa-list-alt"></i><?php echo __('VIEW') ?></a>
                                        <?php
                                        break;
                                    endif;
                                endforeach;
                            ...
                            if (array_key_exists("delete", $module_pages)):
                                ...
                                foreach ($user_permission as $permission):
                                    if ($permission['page_id'] == $page_id):?>
                                                ...
                                                <?php echo $this->Form->postLink(' <i class="fa fa-trash-o"></i>'.__('DELETE'), ['action' => 'delete', $message->message['msg_id']], ['confirm' => __('Are you sure you want to delete {0}?', $message->message['subject']),'escape'=>false]) ?>
