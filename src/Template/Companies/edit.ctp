          ...
          <div class="row">
            <div class="col-md-6">
             ...
             <ul class="nav nav-tabs">
              ...
              <!-- /.form-group -->
              <div class="form-group">
                <?php echo $this->Form->input('company.logo', ['type' => 'file', 'label' => __('Corporate Logo'), 'data-toggle' => 'modal', 'data-target' => '#myModal-3', 'required' => empty($company->logo)?'true':'']); ?>
              </div>
              <!-- /.form-group -->
            ...
            <div id="super_admin_div" class="hide">
             <div class="form-group">
                <?php echo $this->Form->input('cmsuser.language', ['options' => $languages, 'label' => __('LANGUAGE'), 'class' => 'form-control required', 'value' => $cmsuser['language'], 'required' => true]); ?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
                 <?php echo $this->Form->input('cmsuser.email', ['type' => 'email', 'label' => __('EMAIL'), 'pattern' => '^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$', 'class' => 'form-control required', 'value' => $cmsuser['email'], 'required' => true]); ?>
              </div>
              <!-- /.form-group -->
               <div class="form-group">
