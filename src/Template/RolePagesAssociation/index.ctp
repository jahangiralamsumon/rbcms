        ...
        function refreshIcons() {
            ...
            $("a[id^='page_']").each(function () {
                ...
                if ($.inArray(page, array) != -1) {
                    $(this).find("i").removeClass('fa-remove', 100);
                    $(this).find("i").addClass('fa-check', 100);
                    $(this).addClass('color-fa2', 100);
                } else {
                    $(this).find("i").removeClass('fa-check', 100);
                    $(this).find("i").addClass('fa-remove', 100);
                    $(this).removeClass('color-fa2', 100);
                }
            });
        }
